...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Smaugopp/Alice",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Anisaga_network")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/animesintamilz")
